...
namespace NeuralNetwork1
{
    public partial class NeuralNetworksStand : Form
    {
        ...
        public NeuralNetworksStand(Dictionary<string, Func<int[], BaseNetwork>> networksFabric)
        {
            ...
            generator.NumCount = (int) classCounter.Value;
...
#pragma warning restore CS4014 // Because this call is not awaited, execution of the current method continues before the call is completed
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            if (structure.Length < 2 || structure[0] != 600 ||
                structure[structure.Length - 1] != generator.NumCount)
            {
                MessageBox.Show(
                    $"В сети должно быть более двух слоёв, первый слой должен содержать 400 нейронов, последний - ${generator.NumCount}",
